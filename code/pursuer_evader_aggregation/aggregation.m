...
initial_point = rand(var,1)*4-2;
initial_point(var-1:var) = [-2;-2];
...
nonlinearcons = @(x)constraints(x, number_interval, time_interval, number_evader, vemax_repulsion, vemax_attraction, vpmax, K, epsilon, var, initial_point, dth);
...
norm_error = evader_path_verify(number_evader,initial_point,number_interval,time_interval,opt_x,vemax_repulsion,vemax_attraction,K,var,epsilon,dth);