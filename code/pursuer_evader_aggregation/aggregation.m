...
% file = load('../../results-plots/19-03-19/hyperparameters/40.mat');

% hp.initial_pursuer_position = file.initial_pursuer_position;
hp.initial_pursuer_position = [0;0];
...
hp.destination = [1;0];
hp.lower_bound(1:hp.N,1) = -4.0;
hp.upper_bound(1:hp.N,1) = 4.0;
...
'MaxIter', hp.max_iter, 'TolFun', hp.tolfun, 'TolCon', hp.tolcon, 'TolX', hp.tolx, 'Display', 'iter-detailed', ... 
