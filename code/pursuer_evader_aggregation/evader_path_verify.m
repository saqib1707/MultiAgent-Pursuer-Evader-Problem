function [error] = evader_path_verify(Ne, ip, Ni, ti, opt_x, vemax_repulsion, vemax_attraction, K, var, epsilon, fd)
    ...
    evader_position_opt = parameters(1:Ne*2,:);   % which is obtained from optimization
    error = norm(evader_position - evader_position_opt,'fro');
